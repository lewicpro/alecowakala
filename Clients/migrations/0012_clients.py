    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privillages', models.CharField(blank=True, max_length=120, null=True)),
                ('service', models.CharField(blank=True, max_length=120, null=True)),
                ('company', models.CharField(blank=True, max_length=120, null=True, unique=True)),
